...
export default class RegisterForm extends Component
{
    ...
    async onFetchLoginRecords()
    {
        ...
        try
        {
            ...
            let data = {
                UserFullName: this.state.UserFullName, UserName: this.state.PhoneNumber, AddressName: this.state.AddressName
            ...
            <View style={styles.container}>
                ...
                <View style={[styles.TextInputView, { marginBottom: 10 }]}>
                    ...
                    <TextInput style={styles.TextInput}
                        ...
                        autoCorrect={false}
                        onSubmitEditing={() => this.refs.txtAddressName.focus()}
                        ref={"txtEmmail"}
                ...
                <TextInput style={styles.TextInput}
                    ...
                    onChangeText={cn => this.setState({ AddressName: cn })}
                ...
                <View style={styles.signInTxt}>
                    <Text style={{ color: '#c6c7c7' }}>You have account?</Text>
