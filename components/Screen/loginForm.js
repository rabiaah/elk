...
export default class LoginForm extends Component {
  ...
  async onFetchLoginRecords() {
    ...
    try {
        ...
        .then(async (response)=>{
            ...
            if (response && response.isSuccess) {
                if (response.result.result=="success") {
                  await AsyncStorage.setItem("userToken", response.result.user.unique_id);
      ...
      console.log(errors, "uhuihuhuihiuhuihiu");
    }
  }
    ...
    return (
      <View style={styles.container}>
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            this.onPressSubmitButton(this.state.userName, this.state.password)
          }
        >
          <View
        ...
        <View
          style={[styles.LoginButton, (style = { backgroundColor: "#ffffff" })]}
        >
          <TouchableOpacity
            onPress={this.signUp}
            style={{
